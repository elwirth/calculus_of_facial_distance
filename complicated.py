...
save_plot_and_data_simple(fig, vertices, y, name="fragmentation_distance_complicated_vertex_1")
fig = plot_smooth(grid, vert_dists, y, title="Vertex distance", xlabel="x1", ylabel="x2")
save_plot_and_data_simple(fig, vertices, y, name="vertex_distance_complicated_vertex_1")
